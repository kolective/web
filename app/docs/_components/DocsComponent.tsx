  ...
  const features = [
    {
      ...
      description:
        "AgentKit is an AI agent that autonomously manages actions across domains like social media and blockchain, adapting based on experience to deliver highly personalized results.",
    ...
    {
      title: "Let the AI Agent Trade",
      description:
        "Sit back and relax while our AI Agent autonomously trades for you.",
